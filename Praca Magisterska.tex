...
\begin{document}
	...
	\begin{example}[zwycięzca Maximina]
		...
		Kandydaci \(b\) i \(c\) maksymalizują wartość minimalną wyniku i są zwyciężcami maximina.
	\end{example}
	...
	\begin{itemize}
		\item Dyktatura
		\item Metoda punktów Bordy
		\item Metoda Copelanda
	\end{itemize}
	...
	\begin{proof}
		...
		Co więcej, ponieważ dla każdego \(k \neq a\) zachodzi \(m_k < m_a\), kandydat \(a\) jest jedynym maksymalizatorem tej wartości. Kandydat \(a\) jest zatem jedynym zwycięzcą metody maximina.
	\end{proof}
